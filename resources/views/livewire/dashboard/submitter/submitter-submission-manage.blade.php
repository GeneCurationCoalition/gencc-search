      ...
      <div class="grid grid-cols-12 gap-0">
        ...
        <div class="col-span-9 py-1 my-2 border-l-8 pl-3">
            ...
            @elseif($submission->submitted_as_assertion_criteria_url)
              <div class="font-normal"><a class="underline" id='click-exit-assertion-criteria'  href="{{ route('member-show', $submission->submitter->uuid) }}">Click here to view assertion criteria <i class="fas fa-external-link-alt"></i></a></div>
              <div class="text-xs"><a class="" id='click-exit-assertion-criteria'  href="{{ route('member-show', $submission->submitter->uuid) }}">{{route('member-show', $submission->submitter->uuid)  }} <i class="fas fa-external-link-alt"></i></a></div>
            @endif
