                            ...
                            <div class="col-span-9">
                                <div class='grid grid-cols-10'>
                                    ...
                                    <div class="col-span-10 py-1">
                                        <div class="flex">
                                            <div class="flex-none">
                                                <span class=" mb-1 inline-block rounded-full py-1/2 px-3 text-center text-white  whitespace-no-wrap gencc-{{ Str::slug($classification , '') }}">{{ $classification }}</span>
                                            </div>
                                            <div class="flex-grow pl-1">
                                                @foreach ($classification_diseases as $disease)
                                                    <span class=" py-1/2 px-3 border rounded-full border-gray-300 bg-gray-100 px-2 whitespace-no-wrap mb-1 inline-block">{{ $disease['diseases'][0]['title'] }}</span>
                                                @endforeach
                                            </div>
                                        </div>
                                    </div>
