...
@section('headline')
  <div class="grid grid-cols-12 gap-0">
      ...
      <div class="col-span-2 pt-5">
                <div class="text-right mt-6"><a class="px-3" target="gencc-help" href="https://thegencc.org/resources/help/#submitter-index"><i class="fas fa-question-circle"></i> Help</a></div>
