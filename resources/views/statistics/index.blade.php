...
@section('headline')
    <div class="grid grid-cols-12 gap-0">
      ...
      <div class="col-span-2 pt-4 align-bottom">
        <div class="text-right mt-4"><a class="px-3" target="gencc-help" href="https://thegencc.org/resources/help/#stats-index"><i class="fas fa-question-circle"></i> Help</a></div>
      </div>
  </div>
<div class="mt-2">
