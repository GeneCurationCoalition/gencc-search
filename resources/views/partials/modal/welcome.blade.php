        ...
        <div class="mt-3 text-center sm:mt-5">
          ...
          <div class="mt-2 text-left">
            <p class="text-sm pb-2 text-gray-900">
              ...
              You can freely download and search the data, and we encourage the use and publications of validity data for specific targeted sets of genes. H
              owever, we ask that you not publish global (site-wide) analyses of these data, or of large gene sets, until after the GenCC flagship paper has been published (estimated to be spring 2022).
              <b>The preprint of this manuscript is now available <a class="text-blue-700 underline" href="https://www.medrxiv.org/content/10.1101/2022.01.03.21268593v1" target="_medrxiv">here</a> on medRxiv.</b>
              After the flagship publication, data will be available free of restriction under a CC0 1.0 Universal (CC0 1.0) Public Domain Dedication. The GenCC requests that you give attribution to GenCC and the contributing sources whenever possible and appropriate.
            </p>
            <p class="text-sm pb-2 text-gray-900">
