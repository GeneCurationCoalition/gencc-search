	<nav id="header" class="bg-white fixed w-full z-30 top-0 shadow">
		...
		<div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
			...
			<div class="w-1/3 pl-2 mb-4 md:pl-0">
				<a href="https://thegencc.org/resources/faq/#public-beta"><img src="/brand/icons/beta.png" class=" hover:scale-150  transition duration-200 ease-in-out transform  absolute w-10 ml-40 mt-1" /></a>
