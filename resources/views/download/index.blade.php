...
@section('headline')
    <div class="grid grid-cols-12 gap-0">
      ...
      <div class="col-span-2 pt-4 align-bottom">
        <div class="text-right mt-4"><a class="px-3" href="https://thegencc.org/resources/help.html#stats-index"><i class="fas fa-question-circle"></i> Help</a></div>
      </div>
  </div>
@endsection
...
<div class="mt-10">
  <div class="grid lg:grid-cols-2 gap-4 lg:gap-20 xl:gap-40 mb-6">
        ...
        <div>
          <h2>API Access</h2>
          <p class="mb-4">Access to GenCC through and API will be released in early 2021. We recommend anyone interested in access to the API, or would like to be notified when early access is available, to <a href="https://creationproject.us7.list-manage.com/subscribe/post?u=47520fb4e4a2c9edfc44a61af&id=7ccf9c9b09" target="_blank" class="no-underline hover:underline text-blue-800 ">signup</a> so the GenCC to keep you informed.</p>
          <a href="https://creationproject.us7.list-manage.com/subscribe/post?u=47520fb4e4a2c9edfc44a61af&id=7ccf9c9b09" target="_blank" class="o-underline block text-center hover:underline text-blue-800 bg-blue-100 rounded-full text-lg py-2 px-4 leading-tight border-2 border-blue-800 ">
