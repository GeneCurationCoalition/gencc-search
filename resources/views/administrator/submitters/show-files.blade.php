...
<div class=" flex bg-white">
  ...
  <div class="flex flex-col w-0 flex-1">
    ...
    <main class="flex-1 z-0 focus:outline-none" tabindex="0">
      ...
      <div class="px-4 py-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
        <div class="flex-1 min-w-0">
          ...
          <div class="my-4">
            ...
            <div class="inline text-white bg-blue-500 text-center border px-4 py-2"><a href="{{ route('manage-submitter-show-files', $submitter->curie) }}" class="text-white">Submissions Files</a></div>
      ...
      <div class="sm:block" id="link_files">
        <div class="align-middle inline-block min-w-full border-gray-200">
          <div class="px-8 py-4">

            <h3>Submission File Upload</h3>
              @livewire('dashboard.submitter.submission-file-upload', ['submitter' => $submitter])
      ...
      <div class="mt-0 sm:block">
        <div class="align-middle inline-block min-w-full border-b border-gray-200">
          <div class="px-8 pb-8 italic">Note: Enabling/disabling files controls the files processed during the "Process Submissions" action.  <br />Note: Disabling a file doesn't remove submissions already uploaded.</div>
          @livewire('dashboard.submitter.submitter-file-list', ['submitter' => $submitter])
        </div>
      </div>
