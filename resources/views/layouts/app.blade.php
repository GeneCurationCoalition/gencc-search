...
<div class="w-full bg-gray-300">
		<div class="container w-full mx-auto py-3  text-sm">
			...
			<div class="pb-5">
				...
				&copy; 2025 <a href="https://thegencc.org/" class="underline">The GenCC</a> - All rights reserved.
							{{-- <a href="{{ route('reset-modal') }}" class="float-right text-sm text-muted px-2 underline"> GenCC Welcome Statement</a>--}}
							<a href="/privacy" target="_blank" class="float-right text-sm text-muted px-2 underline"> GenCC Website Privacy Policy</a>
							<a href="/terms" target="_blank" class="float-right text-sm text-muted px-2 underline">GenCC Terms of Use</a>
			</div>
