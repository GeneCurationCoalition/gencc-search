...
class deleteSubmitterSubmissions extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'gencc:delete-submissions';
     ...
     * @var string
     */
    protected $description = 'Delete Submissions by submitter';
    ...
    public function handle()
    {
        ...
        //dd($submitter);
        if ($submitter) {
            if ($this->confirm('Are you sure you want to delete all the submissions for ' . $submitter->title . '.', true)) {
                //
            } else {
        ...
        $this->info($count . ' ' . $submitter->title . ' submissions deleted successfully. Wait one minute while the counts are updated...');
